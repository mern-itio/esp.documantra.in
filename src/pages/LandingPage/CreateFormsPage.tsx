...
const CreateFormsPage = () => {
  ...
  const processingSettings = (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        <input type="checkbox" id="enable-submit" className="text-primary-600" defaultChecked />
        <label htmlFor="enable-submit" className="text-sm text-gray-700">
          Add submit button
        </label>
      </div>
    </div>
  ...
  return (
    <PDFToolLayout
      toolName="Create PDF Forms"
      toolDescription="Convert regular PDFs into interactive fillable forms. Add text fields, checkboxes, dropdowns, and signature fields with validation."
      toolIcon={FileText}
      acceptedFormats={['.pdf']}
      outputFormats={['pdf']}
      maxFileSize="100MB"
