    ...
    <section className="section-padding bg-gradient-to-br from-gray-50 to-white">
      <div className="container-max">
        ...
        <div className="mb-16 rounded-3xl bg-gradient-to-r from-[#260559]/90 via-[#4b0ea0]/90 to-[#7b2fff]/90 text-white overflow-hidden">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] items-stretch px-6 py-8 md:px-10 md:py-12">
            ...
            <div className="flex flex-col justify-between gap-8">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full bg-[#F7F3EE]/10 px-3 py-1 text-xs font-medium backdrop-blur">
                ...
                <h2 className="mt-4 text-3xl md:text-4xl font-semibold leading-tight tracking-tight">
                  ...
                  <span className="block text-emerald-100/90">
                    for every document stage
                  </span>
                </h2>
                <p className="mt-4 text-sm md:text-base text-emerald-100/80 max-w-xl">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {platformFeatures.slice(0, 4).map((feature, index) => (
                  <div
                    key={index}
                    className="group rounded-xl bg-[#F7F3EE]/8 p-4 border border-white/10 hover:border-emerald-300/70 transition-colors cursor-pointer"
                  >
                    ...
                    <p className="text-xs md:text-sm text-emerald-50/90 line-clamp-3">
                      {feature.description}
                    </p>
                  </div>
                ))}
            ...
            <div className="relative">
              ...
              <div className="relative h-full rounded-2xl bg-black/15 p-4 md:p-5 border border-white/10 backdrop-blur-sm">
                <p className="text-xs font-medium uppercase tracking-[0.22em] text-emerald-100/70 mb-3">
                ...
                <div className="space-y-3">
                  {platformFeatures.map((feature, index) => (
                    <div
                      key={index}
                      className="flex items-start gap-3 rounded-xl bg-[#F7F3EE]/5 px-3 py-2.5 hover:bg-[#F7F3EE]/10 transition-colors cursor-pointer"
                    >
                      <div className="mt-0.5 flex h-7 w-7 items-center justify-center rounded-full bg-[#F7F3EE]/15 text-[11px] font-semibold">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <span className="hidden md:inline text-[10px] text-emerald-100/70">
                            {feature.features[0]}
                          </span>
                        </div>
        ...
        <div className="relative mb-16">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-gray-100 bg-[#F7F3EE] shadow-lg">
          <div className="grid gap-0 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,1fr)]">
            ...
            <div className="px-6 py-8 md:px-8 lg:px-10 lg:py-10">
              ...
              <ol className="relative mt-4 space-y-5 before:absolute before:left-4 before:top-0 before:h-full before:w-px before:bg-gradient-to-b before:from-emerald-200 before:via-emerald-100 before:to-transparent">
                {workflowSteps.map((step, index) => (
                  <li key={index} className="relative flex gap-4 pl-8">
                    {/* Step node */}
                    <div className="absolute left-0 top-1 flex h-8 w-8 items-center justify-center rounded-full bg-[#F7F3EE] shadow-sm ring-1 ring-emerald-100">
                      <div className="flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-purple-500 text-[11px] font-semibold text-white">
                        {step.step}
                      </div>
                    </div>
                    ...
                    {/* Icon + content */}
                    <div className="flex-1">
                      <div className="mb-1 inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-emerald-700">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {benefits.map((benefit, index) => (
            <div key={index} className=" cursor-pointer border border-transparent hover:border-blue-500 text-center p-6 bg-[#F7F3EE] rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-emerald-200 font-medium">Paid Plans Feature</span>
              </div>
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-emerald-100">Create unlimited organizations</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="h-5 w-5 text-emerald-200" />
                  <span className="text-emerald-100">Invite unlimited team members</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="h-5 w-5 text-emerald-200" />
                  <span className="text-emerald-100">Role-based access control</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle className="h-5 w-5 text-emerald-200" />
                  <span className="text-emerald-100">Shared document libraries</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#F7F3EE]/10 backdrop-blur-sm rounded-xl p-6">
              <div className="bg-[#F7F3EE] rounded-lg p-4 space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-2 bg-[#F5F2EE] rounded-lg">
                  ...
                  <div className="flex items-center gap-3 p-2 bg-[#F5F2EE] rounded-lg">
                    <div className="w-8 h-8 bg-[#F0FDF4]0 rounded-full flex items-center justify-center text-white text-sm font-bold">MJ</div>
                    <div className="flex-1">
                ...
                <Link to="/login">
                  <button className="w-full text-white py-2 rounded-lg text-sm font-medium hover:bg-emerald-700 transition-colors" style={{ backgroundColor: '#260559' }}>
                    + Invite Team Member
                  </button>
     ...
     <div className="p-8 mb-12 text-white rounded-sm bg-gradient-to-r from-[#260559] via-[#4b0ea0] to-[#7b2fff]">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-[#F7F3EE]/10 rounded-lg p-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/signup">
               <button className="flex items-center justify-center gap-2 bg-[#F7F3EE] text-[#260559] hover:bg-gray-100 font-semibold text-base px-6 py-3 rounded-md shadow-md transition-all duration-200">
                Start Free Forever
                ...
                <Link to="/login">
              <button className="flex items-center justify-center gap-2 border-2 border-white text-white hover:bg-[#F7F3EE] hover:text-blue-600 font-semibold text-base px-6 py-3 rounded-md transition-all duration-200">
                View All Features
              </button>
              </Link>
            </div>
