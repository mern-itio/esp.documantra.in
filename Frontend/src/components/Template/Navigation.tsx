...
export const Navigation: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-[#F7F3EE] border-b border-gray-200 z-50">
                ...
                return (
                  <Link
                    ...
                    className={`inline-flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors ${
                      isActive(item.path)
                        ? item.path === '/ai-studio' 
                          ? 'text-[#155E4B] bg-gradient-to-r from-purple-50 to-blue-50 border border-[#BBF7D0]'
                          : item.path === '/admin'
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-[#F7F3EE] border-t border-gray-200">
            {navigationItems.map((item) => {
              const Icon = item.icon;
              return (
                <Link
                  ...
                  className={`flex items-center px-3 py-2 text-base font-medium rounded-md transition-colors ${
                    isActive(item.path)
                      ? item.path === '/ai-studio'
                        ? 'text-[#155E4B] bg-gradient-to-r from-purple-50 to-blue-50'
                        : item.path === '/admin'
