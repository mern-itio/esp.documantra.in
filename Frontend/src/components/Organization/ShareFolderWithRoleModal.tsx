      ...
      <div className="bg-card text-card-foreground border border-border rounded-xl shadow-2xl w-full max-w-2xl mx-4 max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-foreground">Share Folder with Roles</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="max-h-96 overflow-y-auto space-y-2">
              {filteredRoles.map((role) => (
                <div key={role._id} className="border border-border rounded-lg p-4 bg-muted/30 dark:bg-muted/20">
