        ...
        <div className="grid lg:grid-cols-3 gap-8">
                          ...
                          return (
                            ...
                            >
                              <button
                                ...
                                className="w-full text-left p-4 hover:bg-[#F5F2EE] transition-colors flex items-center justify-between"
                              >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl border border-blue-200 p-6">
              ...
              <div className="space-y-3">
                <Link to="/api-documentation" className="flex items-center gap-3 p-3 bg-[#F7F3EE] rounded-lg border border-gray-200 cursor-pointer hover:border-blue-500 transition-shadow">
                ...
                <Link to="/contact-sales" className="flex items-center gap-3 p-3 bg-[#F7F3EE] rounded-lg border border-gray-200 cursor-pointer hover:border-blue-500 transition-shadow">
                ...
                <Link to="/security-overview" className="flex items-center gap-3 p-3 bg-[#F7F3EE] rounded-lg border border-gray-200 cursor-pointer hover:border-blue-500 transition-shadow">
