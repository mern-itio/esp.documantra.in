...
const UnlockPDFPage = () => {
  const handleProcess = async (files: File[], settings: any) => {
    console.log('Processing PDF unlock:', files, settings)
  }
      ...
      <div>
        ...
        <div className="space-y-2">
          <label className="flex items-center gap-2">
            ...
            <span className="text-sm">Remove password protection</span>
          </label>
          <label className="flex items-center gap-2">
            <input type="checkbox" className="text-primary-600" defaultChecked />
      ...
      faqs={[
        {
          ...
          answer: "We can only unlock PDFs if you provide the correct password. We cannot crack or break PDF passwords - you must know the password to unlock the file."
        },
        {
          question: "Is it legal to unlock PDF files?",
          answer: "You should only unlock PDFs that you own or have explicit permission to modify. Removing security from copyrighted documents may violate terms of use."
        },
        {
          question: "What restrictions can be removed?",
          answer: "We can remove password protection, printing restrictions, copying restrictions, and editing restrictions from PDF files."
        },
        {
          question: "Will the PDF quality be affected?",
          answer: "No, unlocking a PDF only removes security restrictions and doesn't affect the document content or quality."
        },
        {
