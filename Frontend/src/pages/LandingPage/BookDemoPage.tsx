      ...
      <section className="py-16 bg-gradient-to-br from-primary-50 via-white to-sky-50 relative overflow-hidden">
        ...
        <div className="container-max relative px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 rounded-full border border-sky-100 bg-white/80 px-3 py-1 text-xs font-medium text-slate-700 shadow-sm backdrop-blur">
      ...
      <section className="mt-10 pb-20">
        <div className="container-max px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)] items-start">
            ...
            <div className="rounded-3xl border border-sky-100 bg-white/90 p-6 sm:p-8 shadow-[0_18px_80px_rgba(15,23,42,0.06)]">
              <div className="mb-6">
              ...
              <form className="space-y-5">
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-1.5">
                    ...
                    <input
                      id="fullName"
                      type="text"
                      className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-[#084bdc] focus:outline-none focus:ring-2 focus:ring-[#084bdc]/20"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        id="workEmail"
                        type="email"
                        className="w-full rounded-xl border border-slate-200 bg-white px-9 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-[#084bdc] focus:outline-none focus:ring-2 focus:ring-[#084bdc]/20"
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <select
                        id="teamSize"
                        className="w-full rounded-xl border border-slate-200 bg-white px-9 py-2.5 text-sm text-slate-900 focus:border-[#084bdc] focus:outline-none focus:ring-2 focus:ring-[#084bdc]/20"
                        defaultValue=""
                      >
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    id="focus"
                    rows={4}
                    className="w-full rounded-2xl border border-slate-200 bg-white px-3 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-[#084bdc] focus:outline-none focus:ring-2 focus:ring-[#084bdc]/20 resize-none"
            ...
            <aside className="space-y-6 rounded-3xl bg-gradient-to-b from-[#260559] to-[#3a0a7e] p-6 sm:p-7 text-white shadow-xl">
              ...
              <div className="mt-4 rounded-2xl bg-white/5 p-4 text-xs flex flex-col gap-3">
