...
const PDFAnnotationRemoverPage = () => {
  ...
  const processingSettings = (
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="space-y-2">
          ...
          <label className="flex items-center gap-2">
            ...
            <span>Remove annotations from specific pages</span>
          </label>
        </div>
      </div>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">
          Page Range (if removing from specific pages)
        </label>
        <input
          type="text"
  ...
  return (
    <PDFToolLayout
      toolName="PDF Annotation Remover"
      toolDescription="Remove comments, highlights, and other annotations from PDF documents. Clean up documents for professional presentation and distribution."
      ...
      howToSteps={[
        ...
        {
          title: "Set Filters",
          description: "Optionally filter by author, date, or pages"
        },
        {
          title: "Download",
      ...
      faqs={[
        {
          ...
          answer: "We can remove comments, highlights, stamps, drawings, sticky notes, text boxes, markup, and other annotation types commonly found in PDFs."
        },
        {
      ...
      relatedTools={[
        ...
        },
        {
          name: "Add Comments",
          path: "/add-comments",
          description: "Add comments to PDF documents"
        },
        {
          name: "Edit PDF",
          path: "/edit-pdf",
...
export default PDFAnnotationRemoverPage