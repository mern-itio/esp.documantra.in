          ...
          <div className="flex flex-wrap items-start justify-between gap-15">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                ...
                className="coupon-btn inline-flex min-h-[40px] items-center justify-center px-4 py-2.5 text-sm font-semibold text-white bg-[#260559] hover:bg-[#260559]/90 transition"
              >
                View Coupons
              </Link>
            </div>
