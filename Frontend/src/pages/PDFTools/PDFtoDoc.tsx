...
export const PdftoDoc: React.FC = () => {
  ...
  const toolInfo = {
    name: 'PDF to Word',
    description: 'Convert PDF documents to editable Word documents with high accuracy',
    icon: FileTextIcon,
    premium: false,
    badge: 'Popular',
    ...
    try {
      ...
      for (let i = 0; i < uploadedFiles.length; i++) {
        ...
        try {
          ...
          const result = await pdfService.convertPdfToDoc(file);
          ...
          <div className="bg-muted rounded-xl border border-border p-6">
            ...
            {uploadedFiles.length > 0 && (
              <FileUploadStatus
                ...
                acceptedFormats={toolInfo.inputFormats || ['pdf']}
                maxFiles={10}
              />
            )}
