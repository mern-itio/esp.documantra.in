...
// Template for creating new PDF tool pages
// Replace the following constants with your tool's specific information
const TOOL_CONFIG = {
  name: 'TOOL_NAME', // e.g., 'Merge PDF', 'Compress PDF'
  description: 'TOOL_DESCRIPTION', // e.g., 'Combine multiple PDF files into one'
  icon: FileTextIcon, // Import the appropriate icon from lucide-react
  premium: false, // Set to true if this is a premium feature
  badge: 'Popular', // Optional badge text, remove if not needed
  complexity: 'easy' as const, // 'easy', 'medium', or 'hard'
  popularity: 85, // Percentage 0-100
  avgProcessingTime: '3-7 seconds', // Estimated processing time
  inputFormats: ['pdf'], // Array of supported input formats
  outputFormats: ['pdf'], // Array of supported output formats
  features: [
    'Feature 1',
    'Feature 2',
    'Feature 3',
...
export const PDFToolTemplate: React.FC = () => {
