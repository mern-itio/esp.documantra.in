...
export const PdfToImage: React.FC = () => {
  ...
  // Hardcoded tool information for PDF to Image
  const toolInfo = {
    name: 'PDF to Image',
    description: 'Convert PDF files to Image file with high accuracy',
    icon: FileTextIcon,
    premium: false,
    // badge: 'Popular',
  ...
  const processFiles = async () => {
    ...
    try {
      ...
      for (let i = 0; i < uploadedFiles.length; i++) {
        ...
        try {
          console.log(`Converting ${file.name} to images...`);
          ...
          {uploadedFiles.length > 0 && (
            <div className="bg-muted rounded-xl border border-border p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-foreground">Convert PDF to Image</h3>
                <button
              ...
              {isProcessing && (
                <div className="mb-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-foreground">Converting PDF to Images...</span>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <p className="font-medium text-foreground">{result.name}</p>
                          ...
                          {result.status === 'success' && result.fileCount && (
                            <p className="text-sm text-muted-foreground">Images: {result.fileCount}</p>
                          )}
