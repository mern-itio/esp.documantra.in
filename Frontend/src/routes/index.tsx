...
import {
  ...
  CookiePolicyPage,
  TermsOfServicePage,
  ElectronicRecordDisclosurePage,
  UseCasesPage,
  WorkspacePage,
...
const guestRoutes = [
  ...
  // Canonical legal pages (one URL each — aliases redirect below)
  { path: '/privacy-policy', element: <PrivacyPolicyPage /> },
  { path: '/terms-of-use', element: <TermsOfServicePage /> },
  { path: '/electronic-record-disclosure', element: <ElectronicRecordDisclosurePage /> },
  { path: '/cookie-policy', element: <CookiePolicyPage /> },
  { path: '/privacy', element: <Navigate to="/privacy-policy" replace /> },
  { path: '/terms', element: <Navigate to="/terms-of-use" replace /> },
  { path: '/terms-of-service', element: <Navigate to="/terms-of-use" replace /> },
...
const authRoutes = [
  ...
  { path: '/platform/admin-login', element: <AdminLocalLogin /> },
  { path: '/admin/login', element: <Navigate to="/platform/admin-login" replace /> },
  { path: '/e-sign/admin', element: <EsignESignatureAdmin /> },
  { path: '/e-sign/admin/vsign', element: <VSignAdminSettings /> },
