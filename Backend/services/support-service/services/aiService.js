...
class AIService {
  ...
  buildSystemPrompt(ticketContext) {
    ...
    if (!kb) {
      ...
      return 'You are a helpful AI support assistant for Draft and Sign platform.';
    }
    
    let prompt = `You are a helpful AI support assistant for Draft and Sign, a comprehensive electronic signature and document management platform.
