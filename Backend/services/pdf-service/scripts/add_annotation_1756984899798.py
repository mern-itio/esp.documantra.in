...
def add_annotation(document_id, annotation, page_number):
    try:
        ...
        # Save the document with incremental update
        try:
            doc.save(doc_path, incremental=True, encryption=fitz.PDF_ENCRYPT_NONE)
        except Exception as save_error:
            # If incremental save fails, try regular save
            print(f"Warning: Incremental save failed, trying regular save: {save_error}")
            doc.save(doc_path)
        doc.close()
...
if __name__ == "__main__":
    document_id = "doc_1756984892525"
    annotation = {"id":"ann_1756984899732_s8ibuh7dw","type":"text","pageNumber":1,"position":{"x":38.83746337890625,"y":51,"width":100,"height":20},"content":"Click to edit text","style":{"color":"#000000","fontSize":12,"fontFamily":"Arial","fontWeight":"normal","textAlign":"left","backgroundColor":"transparent"},"author":"Current User","createdAt":"2025-09-04T11:21:39.732Z","isLocked":False,"isVisible":True,"zIndex":1}
    page_number = 1
