...
if __name__ == "__main__":
    document_id = "doc_1756984332114"
    annotation = {"id":"ann_1756984344873_giqfvppeu","type":"text","pageNumber":1,"position":{"x":27.83746337890625,"y":43,"width":100,"height":20},"content":"Click to edit text","style":{"color":"#000000","fontSize":12,"fontFamily":"Arial","fontWeight":"normal","textAlign":"left","backgroundColor":"transparent"},"author":"Current User","createdAt":"2025-09-04T11:12:24.873Z","isLocked":False,"isVisible":True,"zIndex":1}
    page_number = 1
