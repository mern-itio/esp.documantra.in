...
// Apply anonymousLimiter before tracking on public tool routes
app.use('/pdf', anonymousLimiter, trackPdfOperation, pdfRoutes);
app.use('/convert', anonymousLimiter, trackPdfOperation, conversionRoutes);
app.use('/pdf-text-edit', anonymousLimiter, trackPdfOperation, pdfTextEditRoutes);
app.use('/pdf-service', anonymousLimiter, trackPdfOperation, mergePdfRoutes);
app.use('/pdf-split', anonymousLimiter, trackPdfOperation, splitPdfRoutes);
app.use('/pdf-extract', anonymousLimiter, trackPdfOperation, extractPdfRoutes);
app.use('/pdf-delete', anonymousLimiter, trackPdfOperation, deletePdfPagesRoutes);
app.use('/pdf-reorder', anonymousLimiter, trackPdfOperation, reorderPdfPagesRoutes);
app.use('/pdf-rotate', anonymousLimiter, trackPdfOperation, rotatePdfPagesRoutes);
app.use('/pdf-crop', anonymousLimiter, trackPdfOperation, cropPdfPagesRoutes);
app.use('/pdf-insert', anonymousLimiter, trackPdfOperation, insertPdfPagesRoutes);
app.use('/pdf-page-numbers', anonymousLimiter, trackPdfOperation, addPageNumbersRoutes);
app.use('/pdf-header-footer', anonymousLimiter, trackPdfOperation, addHeaderFooterRoutes);
app.use('/pdf-password', anonymousLimiter, trackPdfOperation, addPasswordRoutes);
app.use('/pdf-remove-password', anonymousLimiter, trackPdfOperation, removePasswordRoutes);
app.use('/pdf-digital-signature', anonymousLimiter, trackPdfOperation, digitalSignatureRoutes);
app.use('/pdf-permissions', anonymousLimiter, trackPdfOperation, setPermissionsRoutes);
app.use('/pdf-watermark', anonymousLimiter, trackPdfOperation, addWatermarkRoutes);
app.use('/pdf-remove-metadata', anonymousLimiter, trackPdfOperation, removeMetadataRoutes);
app.use('/pdf-edit-metadata', anonymousLimiter, trackPdfOperation, editMetadataRoutes);
app.use('/pdf-spell-check', anonymousLimiter, trackPdfOperation, spellCheckRoutes);
app.use('/pdf-find-replace', anonymousLimiter, trackPdfOperation, findReplaceRoutes);
app.use('/pdf-redact', anonymousLimiter, trackPdfOperation, redactRoutes);
app.use('/pdf-stamps', anonymousLimiter, trackPdfOperation, stampRoutes);
app.use('/pdf-comments-db', anonymousLimiter, trackPdfOperation, dbCommentRoutes);
app.use('/pdf-highlight', anonymousLimiter, trackPdfOperation, highlightRoutes);
app.use('/pdf-compress', anonymousLimiter, trackPdfOperation, compressPDFRoutes);
app.use('/pdf-optimize-image', anonymousLimiter, trackPdfOperation, optimizeImageRoutes);
app.use('/pdf-optimize-font', anonymousLimiter, trackPdfOperation, optimizeFontRoutes);
app.use('/pdf-remove-unused-objects', anonymousLimiter, trackPdfOperation, removeUnusedObjectsRoutes);
app.use('/pdf-linearize', anonymousLimiter, trackPdfOperation, linearizePDFRoutes);
app.use('/pdf-color-optimization', anonymousLimiter, trackPdfOperation, colorOptimizationRoutes);
app.use('/pdf-quality-analysis', anonymousLimiter, trackPdfOperation, qualityAnalysisRoutes);
app.use('/pdf-batch-optimization', anonymousLimiter, trackBatchOperation, batchOptimizationRoutes);
app.use('/pdf-ocr', anonymousLimiter, trackPdfOperation, ocrRoutes);
app.use('/pdf-make-searchable', anonymousLimiter, trackPdfOperation, makeSearchableRoutes);
app.use('/pdf-extract-tables', anonymousLimiter, trackPdfOperation, extractTablesRoutes);
app.use('/pdf-handwriting-recognition', anonymousLimiter, trackPdfOperation, handwritingRecognitionRoutes);
app.use('/pdf-create-form', anonymousLimiter, trackPdfOperation, createPdfFormRoutes);
app.use('/pdf-fill-form', anonymousLimiter, trackPdfOperation, fillPdfFormRoutes);
app.use('/pdf-form-recognition', anonymousLimiter, trackPdfOperation, formRecognitionRoutes);
app.use('/pdf-calculate-fields', anonymousLimiter, trackPdfOperation, calculateFieldsRoutes);
app.use('/pdf-info', anonymousLimiter, trackPdfOperation, pdfInfoRoutes);
app.use('/pdf-validator', anonymousLimiter, trackPdfOperation, pdfValidatorRoutes);
app.use('/pdf-compare', anonymousLimiter, trackPdfOperation, pdfCompareRoutes);
app.use('/pdf-repair', anonymousLimiter, trackPdfOperation, pdfRepairRoutes);
app.use('/pdf-bookmarks', anonymousLimiter, trackPdfOperation, pdfBookmarksRoutes);
app.use('/pdf-statistics', anonymousLimiter, trackPdfOperation, pdfStatisticsRoutes);
app.use('/advanced-editor', anonymousLimiter, trackPdfOperation, advancedPdfEditorRoutes);
